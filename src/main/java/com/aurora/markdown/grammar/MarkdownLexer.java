...
public class MarkdownLexer extends Lexer {
	...
	public static final int
		Letter=1, Digit=2, Space=3, Tab=4, Newline=5, WhiteSpace=6, Star=7, Tilde=8, 
		Underscore=9;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"Letter", "Digit", "Space", "Tab", "Newline", "WhiteSpace", "Star", "Tilde", 
			"Underscore"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "Letter", "Digit", "Space", "Tab", "Newline", "WhiteSpace", "Star", 
			"Tilde", "Underscore"
		};
	}
